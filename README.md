...
```
$ git clone https://github.com/MelissaData/NameObject-Cpp-Linux.git
...
2.  If you already have the latest DQS Release (ZIP), you can find the data file(s) and dll(s) in there
	...
	- Navigate into the `MelissaNameObjectLinuxCpp` project folder, create a folder named `Build`, and copy all the dll(s) mentioned above into the `Build` folder.
    - Copy all dependencies mentioned above into the `MelissaNameObjectLinuxCpp` project folder.
